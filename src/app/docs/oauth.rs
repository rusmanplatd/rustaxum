...
#[openapi(
    info(
        ...
        version = "1.0.0",
        description = "**OAuth 2.1 Compliant Authorization Server**\n\nEnterprise-grade OAuth 2.1 implementation with Laravel Passport compatibility, built with Rust for maximum security and performance.\n\n## 🔒 OAuth 2.1 Compliance\n\n**RFC Standards Implemented:**\n- [draft-ietf-oauth-v2-1-13](https://datatracker.ietf.org/doc/draft-ietf-oauth-v2-1/) - OAuth 2.1 Authorization Framework\n- [RFC 7636](https://tools.ietf.org/html/rfc7636) - PKCE (Proof Key for Code Exchange) - **MANDATORY**\n- [RFC 7662](https://tools.ietf.org/html/rfc7662) - Token Introspection\n- [RFC 6750](https://tools.ietf.org/html/rfc6750) - Bearer Token Usage\n- [RFC 9700](https://tools.ietf.org/html/rfc9700) - OAuth Security Best Practices\n\n**Security Enhancements:**\n- ✅ **Mandatory PKCE**: All authorization code flows require PKCE\n- ❌ **Removed Implicit Grant**: Deprecated for security reasons\n- ❌ **Removed Password Grant**: Deprecated for security reasons\n- ✅ **Exact URI Matching**: Redirect URIs require exact string matching\n- ✅ **Short-lived Codes**: Authorization codes expire in 10 minutes\n- ✅ **Token Rotation**: Refresh tokens are rotated on each use\n\n## 🏢 Enterprise Features\n\n- **Multi-tenant Support**: Organization-scoped client access control\n- **JWT Tokens**: Stateless token validation with configurable secrets\n- **Comprehensive Auditing**: Full OAuth activity logging and monitoring\n- **Rate Limiting**: Built-in protection against abuse\n- **Health Monitoring**: Real-time system status and metrics\n- **CLI Administration**: Laravel Artisan-style management commands\n\n## 🔑 Authentication\n\nMost endpoints require Bearer token authentication:\n\n```http\nAuthorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...\n```\n\n## 📋 Supported Grant Types\n\n### Authorization Code Grant (OAuth 2.1)\n**PKCE Required** - Secure flow for web and mobile applications\n```http\n/oauth/authorize?response_type=code&client_id=...&code_challenge=...&code_challenge_method=S256\n```\n\n### Client Credentials Grant\nMachine-to-machine authentication for server applications\n```http\nPOST /oauth/token\ngrant_type=client_credentials&client_id=...&client_secret=...\n```\n\n### Refresh Token Grant\nRenew access tokens using refresh tokens (with rotation)\n```http\nPOST /oauth/token\ngrant_type=refresh_token&refresh_token=...&client_id=...\n```\n\n## 🎯 Scope System\n\nFine-grained permission control:\n\n| Scope | Description | Default |\n|-------|-------------|----------|\n| `*` | Full administrative access | ❌ |\n| `read` | Read access to resources | ✅ |\n| `write` | Write access to resources | ❌ |\n| `admin` | Administrative operations | ❌ |\n| `oauth:clients` | Manage OAuth clients | ❌ |\n| `oauth:tokens` | Manage OAuth tokens | ❌ |\n| `user:profile` | Access user profile | ❌ |\n\n## 🌐 Multi-tenant Architecture\n\n- **Global Clients**: Access across all organizations (organization_id = null)\n- **Scoped Clients**: Access restricted to specific organization members\n- **Organization Validation**: Automatic user membership verification",
        contact(
