...
#[utoipa::path(
    ...
    params(
        ...
        ("sort" = Option<String>, Query, description = "Sort field and direction. Available fields: id, model_type, model_id, role_id, scope_type, scope_id, created_at, updated_at (prefix with '-' for descending)"),
        ("include" = Option<String>, Query, description = "Comma-separated list of relationships to include. Available: role, model, createdBy, updatedBy, deletedBy, createdBy.organizations.position.level, updatedBy.organizations.position.level, deletedBy.organizations.position.level"),
        ("filter" = Option<serde_json::Value>, Query, description = "Filter parameters. Available filters: model_type, model_id, role_id, scope_type, scope_id (e.g., filter[model_type]=User, filter[scope_type]=organization)"),
        ("fields" = Option<String>, Query, description = "Comma-separated list of fields to select. Available: id, model_type, model_id, role_id, scope_type, scope_id, created_at, updated_at"),
