...
use diesel::prelude::*;
use crate::schema::{organization_domains, organization_types};
...
impl Seeder for OrganizationTypeSeeder {
    ...
    fn run(&self, pool: &DbPool) -> Result<()> {
        ...
        let types_data = vec![
            ...
            ("EDU", vec![
                ("UNIV", "University", "University or higher education institution", 1),
        ...
        for (domain_code, types) in types_data {
            ...
            for (code, name, description, level) in types {
                ...
                println!("      ✓ Created type: {} ({}) - Level {}", name, code, level);
            }
        }
