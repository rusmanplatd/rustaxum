...
CREATE INDEX idx_oauth_clients_created_by_id ON oauth_clients (created_by_id);
CREATE INDEX idx_oauth_clients_updated_by_id ON oauth_clients (updated_by_id);
CREATE INDEX idx_oauth_clients_deleted_by_id ON oauth_clients (deleted_by_id);
