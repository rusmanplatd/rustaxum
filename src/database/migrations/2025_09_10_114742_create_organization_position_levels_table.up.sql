...
CREATE INDEX idx_organization_position_level_created_by ON organization_position_levels (created_by);
CREATE INDEX idx_organization_position_level_updated_by ON organization_position_levels (updated_by);
CREATE INDEX idx_organization_position_level_deleted_by ON organization_position_levels (deleted_by);
